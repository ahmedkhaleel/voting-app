...
<head>
    ...
    <title>Ahmed Khaleel - Voting</title>
...
<header class="flex flex-col md:flex-row items-center justify-between px-8 py-4">
    <h1 class="font-bold text-xl border-2  border-blue px-4 p-4 hover:bg-blue hover:text-white rounded-xl">Ahmed Khaleel
        - Voting</h1>
        ...
        >
            ...
            @else
                ...
                <a href="{{route('login')}}"
                    ...
                    <a
                        href="{{route('register')}}"
                        class=" inline-block justify-center  w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
                    >
