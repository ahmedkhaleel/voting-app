                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        @if ($hasVoted)
                            <button
                                ...
                                class="w-20 bg-blue text-white border border-gray-200 font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5"
                            >
                                Vote
                            </button>
                        @else
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button
                    wire:click.prevent="vote"
                    type="button"
                    class="w-32 h-11 text-xs bg-blue  text-white font-semibold uppercase rounded-xl border border-gray-200 hover:border-blue transition duration-150 ease-in px-6 py-3"
                >
                    <span>Vote</span>
                </button>
                @else
