<form wire:submit.prevent="createIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
 ...
 @foreach($categories as $category)
    ...
    @enderror
    <div>
        <textarea wire:model.defer="description" name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2" placeholder="Describe your idea" required>
    ...
    <div class="bg-gray">
        @if(session('success_message'))
            <div
                ...
                class="text-green text-centermt-4">
