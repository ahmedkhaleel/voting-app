        ...
        <div class="idea-container hover:shadow-card  transition duration-150 ease-in  bg-white rounded-xl flex cursor-pointer">
            <div class="border-r border-gray-100 px-5 py-8">
                <div class="text-center">
                    ...
                    <div class="mt-8">
                        <button class="w-20 bg-gray-200 transition duration-150 ease-in text-sm  border border-gray-200 hover:border-gray-400 font-bold text-xs uppercase rounded-xl px-4 py-3">Vote</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in py-2 px-3">
                                <svg class="w-4 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"></path></svg>
                            <ul class="absolute p-4 ml-8 w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3">
                                <li>
                                    <a href="#" class="hover:bg-gray-100 block transition duration-150">Make as Spam</a>
                                </li>
                                <li>
                                    <a href="#" class="hover:bg-gray-100 block transition duration-150">Delet Post</a>
                                </li>
                            </ul>
                            </button>
