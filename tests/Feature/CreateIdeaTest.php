...
class CreateIdeaTest extends TestCase
{
    ...
    public function creating_an_idea_works_correctly(){
        ...
        $categoryTow = Category::factory()->create(['name' => 'Category 2']);
    ...
    /** @test */
    public function creating_tow_ideas_same_title_still_works_but_has_different_slug(){
        ...
        $response = $this->actingAs($user)->get(route('idea.index'));
        $response->assertSuccessful();
        $response->assertSee('My second Idea');
